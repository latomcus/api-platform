...
module.exports = {
    ...
    'cache.add': function (data_in, callback){
        //your business logic here...

        callback( {
            code: 'f.c.2', //function . cache . #
            message: 'Cache added, by action name',
            data: {token: data_in.token, payload: data_in.payload},
    ...
    'about-->cache.add': function (){ // documentation
        return {
            title: 'cache.add',
    ...
    'cache.remove': function (data_in, callback){
        //your business logic here...
        ...
        callback ( {
            ...
            actions: [{
                ...
                key_type: 'action',
                key_value: 'cache.remove'
            }]
        })
    },

    'about-->cache.remove': function (){ // documentation
        return {
            title: 'cache.remove',
